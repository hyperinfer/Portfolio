*2. Event: Absturz der Airbus A320-211 Maschine des Germanwings Fluges 9525 am 24 März 2015*
*Die Durchführung der zweiten Eventstudy orientiert sich ziemlich genau an der Ersten*
...
import excel "C:\Users\Felix\OneDrive - studium.uni-hamburg.de\Studium VWL UHH\Semester 5\Empirische Stadt- und Immobilienökonomik\Eigene Inhalte\STATA\2.Event\Event_9525.xlsx", sheet("Kurse") firstrow

*Merge mit dem Event-Datensatz*
merge 1:1 Datum using "C:\Users\Felix\OneDrive - studium.uni-hamburg.de\Studium VWL UHH\Semester 5\Empirische Stadt- und Immobilienökonomik\Eigene Inhalte\STATA\2.Event\20150324_SET.dta", force
drop _merge

*Terminierung der Daten*
*Um in unserem festgelegten Eventwindow Arbeiten zu können, werden die einzelen Daten damit gekennzeichnet, wie viele Markttage sie vor bzw. nach eintreten des Events liegen.*
...
*Crash-Indikator*
*Zur Verwendung in einer späteren Regression, definieren wir eine Dummy, die am Tag des Events den Wert Eins annimmt!"
gen Crash = 0
...
*Um die Entwicklung der abnormalen Renditen besser in Relation zum Zeitraum vor und nach Eintritt des Events erkennen zu können, werden die dursch. Werte pro Tag berechnet*
...
*Um schließlich spezifischere Rückschlüsse auf die Auswirkung des Events in unserem Eventwindow zu erhalten, werden die dursch. abnormalen Rendite in diesem Zeitraum kumuliert*
...
*Schätzung der kumulierten Effekte*
...
graph twoway (lpoly Rendite_Airbus Termin, degree(25)) (lpoly Renditeerwartung_Airbus Termin, degree(25))
